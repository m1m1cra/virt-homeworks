...
Различные web-приложения - можно вполне запустить в кластере proxmox,  или в кубере:)
...
#### Ответ
Такая инфраструктура на VSphere с оркестрацией VCenter + Veeam будет жить на ура. 
