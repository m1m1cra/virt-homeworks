...
Packer в части создания образов, terraform для создания машин, сетей и т.д в облакаха, докер и кубер как его оркестрацию, Ansbile - да, а вот баш скрипты попытался бы увести в ansible. Teamcity - да.
